...
export default function ArtigosPage() {
  return (
    <main role="main" aria-label="Artigos e Reflexões">
      <h1 className="sr-only">Artigos e Reflexões</h1>
      <section aria-labelledby="artigos-heading">
        <h2 id="artigos-heading">Leia os artigos abaixo</h2>
        <article className="blog-artigo" aria-labelledby="artigo-juventude-heading">
          <h3 id="artigo-juventude-heading">O Propósito da Juventude Cristã</h3>
